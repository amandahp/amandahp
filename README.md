...
<body>
  <div>
    ...
    <section>
      <h3>Hi Stranger, I'm Amanda.</h3>
      <p> 
        Some information that may be of interest to you:<br> 
        I'm a cyborg and I work for a company that collects data. LOL, I wish I had the ability to understand binary, in reality, I'm just another fan of informatics, and to achieve communication with my muse, as poets need their muses for inspiration, I decided to enter the world of programming.<br> 
        I am a Systems Analysis and Development student and I also do a bootcamp in Web Development. Learning is always good, knowledge frees you from the anguish of ignorance.<br> 
        I currently live in São Paulo, the stone jungle, in Brazil. It's a great place to isolate yourself at home and try to learn as many programming languages as possible, it's a joke - HAHA -.<br> 
        I've been in the technology market since 2020, and since then I've been dedicating myself to some programming languages, namely: Java...script - it's Java, I haven't had the opportunity to do crazy things with you -, and Python - I love Python, the more you think you're getting an expert at programming in Python, a raise Timeout error will remind you that you're not even at the beginning - . As a particular curious person, whenever possible, I try to learn other languages, one day Clojure will be my vocation, I believe, or maybe Golang will make me go - HAHA -.<br> 
      </p>
      <h3>If you want to get in touch, my contact networks are available below:</h3>
    </section>
    <table>
      <tbody>
        <tr> 
    ...
    <section>
      <h4>I like to do some challenges to warm up the mind, if you are interested, my profile on some sites that have programming challenges is right below:</h4>
    </section>
    <table>
      <tbody>
        <tr class="challenges-site">
          <td><a href="https://www.codewars.com/users/amandahp">
            <img src="https://www.codewars.com/users/amandahp/badges/micro" />
          </a></td>
          <td><a href="https://www.hackerrank.com/amandahoffmann96">
            <img  src="https://upload.vectorlogo.zone/logos/hackerrank/images/7f113bba-8436-47a5-9982-af0bc4c02a8e.svg"/>
          </a></td>
